...
class AppLocalizationsIt extends AppLocalizations {
  ...
  @override
  String get benefitSpeedDesc => 'Navigazione più fluida.';
  ...
  @override
  String get tutorialOneTitle => 'Valute e Date';

  @override
  String get tutorialOneDesc =>
      'Passa tra Dollaro, Euro e tassi personalizzati. Puoi anche controllare i tassi di Oggi e Domani.';

  @override
  String get tutorialTwoTitle => 'Ordine di Conversione';

  @override
  String get tutorialTwoDesc =>
      'Tocca qui per cambiare l\'ordine. Digita in Dollari per vedere i Bolivar, o viceversa.';

  @override
  String get tutorialThreeTitle => 'Scanner Intelligente';

  @override
  String get tutorialThreeDesc =>
      'Usa la fotocamera per rilevare i prezzi e convertirli automaticamente in tempo reale.';
  ...
  @override
  String get tutorialFinish => 'Fine';
  ...
  @override
  String get accountDigitsHelper => 'Deve avere 20 cifre';

  @override
  String accountDigitsCount(Object count) {
    return '$count/20 cifre';
  }

  @override
  String get accountDigitsExact => 'Deve avere esattamente 20 cifre';

  @override
  String aliasAlreadyExists(Object alias) {
    return 'L\'alias \"$alias\" esiste già';
  }

  @override
  String pagoMovilAlreadyExists(Object name) {
    return 'Questo conto di pagamento mobile esiste già con il nome \"$name\"';
  }

  @override
  String bankAccountAlreadyExists(Object name) {
    return 'Questo conto bancario esiste già con il nome \"$name\"';
  }
}
